...
/***/ function(module, exports, __webpack_require__) {
	...
	var EditorComponent = __webpack_require__(164);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var ReactLogoComponent = __webpack_require__(158);
	var ForkmeonComponent = __webpack_require__(160);
	var pkg = __webpack_require__(163);
	    ...
	    value: function render() {
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(ReactLogoComponent, null)
	        ),
...
/***/ function(module, exports) {
	...
	module.exports = {
		...
		"keywords": [],
		"homepage": "http://xudafeng.github.io/mock",
		"author": "xudafeng@126.com",
		"repository": {
			"type": "git",
			"url": "https://github.com/xudafeng/mock.git"
		},
		"scripts": {
			"lint": "make lint"
		},
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EditorComponent = (function (_React$Component) {
	  ...
	  _createClass(EditorComponent, [{
	    ...
	    key: 'getGridTypeNumber',
	    value: function getGridTypeNumber() {
	      return this.state.showHelper ? 4 : 6;
	    }
	  }, {
	    key: 'getHelperStatus',
	    value: function getHelperStatus() {
	      return this.state.showHelper ? '' : 'hide';
	    }
	  }, {
	    key: 'getEditorStyle',
	    value: function getEditorStyle() {
	      return {
	        height: this.state.containerHeight
	      };
	    }
	  }, {
	    key: 'getEditorNavStyle',
	    value: function getEditorNavStyle() {}
	  }, {
	    key: 'render',
	    value: function render() {
	      return React.createElement(
	        'div',
	        { className: 'editor row', style: this.getEditorStyle() },
	        React.createElement(
	          'nav',
	          { className: 'editor-nav', style: this.getEditorNavStyle() },
	          '12323'
	        ),
	        React.createElement(
	          'div',
	          { className: 'template col-md-' + this.getGridTypeNumber(), ref: 'template' },
	          'template'
	        ),
	        React.createElement(
	          'div',
	          { className: 'output col-md-' + this.getGridTypeNumber(), ref: 'output' },
	          'output'
	        ),
	        React.createElement(
	          'div',
	          { className: 'helper col-md-' + this.getGridTypeNumber() + ' ' + this.getHelperStatus(), ref: 'helper' },
	          'helper'
	        )
	      );
	    }
